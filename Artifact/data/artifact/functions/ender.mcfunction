...
execute as @e[tag=ender_shot,nbt={inGround: 1b}] at @s run summon area_effect_cloud ~ ~ ~ {Radius:3f, Duration:60, Color:5375826, Potion:"minecraft:harming"}
execute as @e[nbt={ActiveEffects:[{Id:27b, Amplifier:0b}]}] at @s run summon area_effect_cloud ~ ~ ~ {Radius:3f, Duration:60, Color:5375826, Potion:"minecraft:harming"}
execute as @e[tag=ender_shot,nbt={inGround: 1b}] at @s run kill @s

# reset scoreboard
scoreboard players remove @a[scores={ender_shot=1..}] ender_shot 1