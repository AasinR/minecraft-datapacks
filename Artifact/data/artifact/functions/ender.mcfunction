...
execute as @s[nbt={SelectedItem: {id: "minecraft:bow", Count: 1b, tag: {CustomModelData: 673601}}},scores={arrow_shot=1..}] at @s run tag @e[type=minecraft:arrow,sort=nearest,limit=1] add ender_shot
